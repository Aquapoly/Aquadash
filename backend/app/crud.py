from sqlalchemy import and_, insert, select, update, inspect, text
...
def ensure_notification_columns(db: Session):
    ...
    # TODO: Delete once we are sure no DB has the old schema (with message instead of description)
